	...
	<div class="w-full bg-white shadow">
		<div class="max-w-screen-2xl mx-auto h-16 px-40 flex">
			<div class="flex flex-no-wrap items-center space-x-4 overflow-hidden whitespace-no-wrap">
				...
				<NuxtLink to="/" class="nav-link hover:text-gray-900">Education</NuxtLink>
				<NuxtLink to="/" class="nav-link hover:text-gray-900">ISS</NuxtLink>
				<NuxtLink to="/" class="nav-link hover:text-gray-900">NASA</NuxtLink>
				<NuxtLink to="/" class="nav-link hover:text-gray-900">ESA</NuxtLink>
				<NuxtLink to="/" class="nav-link hover:text-gray-900">JAXA</NuxtLink>
				<NuxtLink to="/" class="nav-link hover:text-gray-900">SpaceX</NuxtLink>
